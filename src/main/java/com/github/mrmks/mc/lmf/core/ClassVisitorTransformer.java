...
import com.github.mrmks.mc.lmf.ccl.WorldExtensionEventHandlerClassVisitor;
...
public class ClassVisitorTransformer implements IClassTransformer {

    private final String[] nameList = new String[]{
            "codechicken.lib.world.WorldExtensionManager$WorldExtensionEventHandler0"
    };
    private final TransformerBuilder[] transList = new TransformerBuilder[] {
            WorldExtensionEventHandlerClassVisitor::new
    };
